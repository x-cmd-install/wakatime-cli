...
[![x-cmd/install — wakatime-cli Code Quality Monitoring Repo Card](https://repo.x-cmd.io/wakatime-cli.svg?lang=zh)](https://x-cmd.com/install/wakatime-cli)
...
合计: **92,869** 行代码（覆盖前 5 种语言、共 **838** 个文件）。
...
- **最新版本**: `v2.26.5` (2026-09-21)
- **最近提交**: 2026-09-21
- **Release 含资产**: 23 个

## 流行度

- **Star**: 453 · **Fork**: 90 · **开放 issue**: 383 · **贡献者**: 16

## 累计统计

- **发布数**: 800 · **已合并 PR**: 1045 · **开放 PR**: 1 · **已关闭 issue**: 373 · **开放 issue**: 10 · **提交数**: 1831
...
_数据快照: `data/card/260921.yml` · 2026-09-21T06:28:25Z._
